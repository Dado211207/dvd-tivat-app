...
export const me = {
  ...
  accountAccess: {
    ...
    profileRequired: 'Nalog je napravljen. Unesite ime i prezime da bi vlasnik znao ko trazi pristup.',
    ...
    profileSaveFailed: 'Ime i prezime nijesu sacuvani. Pokusajte ponovo.',
    resetUnavailable: 'Promjena zaboravljene lozinke jos nije dostupna. Do tada lozinku mijenja vlasnik sistema.',
    suspended: 'Pristup ovom nalogu je ukinut. Razlog je zapisan na serveru; obratite se vlasniku sistema.',
    awaitingApproval: 'Nalog je aktivan, ali jos nema prava u sistemu. Samo vlasnik moze dodijeliti ulogu. Do tada operativni ekrani nijesu dostupni.',
    signedInAs: 'Prijavljeni nalog', serverRole: 'Uloga sa servera',
  ...
  accounts: {
    ...
    search: 'Pretrazi po imenu, emailu, ulozi ili statusu', loading: 'Ucitavam naloge sa servera...',
    ...
    auditKicker: 'Trajna evidencija', auditTitle: 'Promjene uloga i pristupa', noAudit: 'Jos nema zapisa',
    auditHint: 'Evidencija se popunjava kada se promijeni uloga ili pristup.',
    ...
    nameAndSurname: 'Ime i prezime', displayNotProof: 'Prikazni podatak, ne dokaz identiteta.',
    awaitingApproval: 'Ceka odobrenje', noRights: 'Novi nalog nema prava u sistemu.',
    ownerDecision: 'Odluka vlasnika', ownerAssigns: 'Samo vlasnik moze dodijeliti ulogu.',
    serverCheck: 'Provjera na serveru', serverChecksRole: 'Server provjerava ulogu pri svakom zahtjevu.',
    roleLabel: { OWNER: 'Vlasnik sistema', ADMIN: 'Administrator', COMMANDER: 'Komandir', FIREFIGHTER: 'Vatrogasac', PENDING: 'Ceka odobrenje', CITIZEN: 'Gradjanin (stara oznaka)' },
  ...
  gate: {
    ...
    awaitingApprovalTitle: 'Nalog ceka odobrenje.',
    awaitingApprovalText: 'Vlasnik dodjeljuje ulogu, i tek tada se operativni ekrani otvaraju.',
