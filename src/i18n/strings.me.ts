...
export const me = {
  app: {
    ...
    subtitle: 'Operativni prototip',
    /** The one-word mark in the corner. */
    mark: 'D',
  },
  ...
  nav: {
    ...
    workspace: 'DVD Tivat radni prostor',
  ...
  push: {
    ...
    installOnIos: 'Na iPhoneu prvo izaberite Podijeli - Dodaj na pocetni ekran, otvorite DVD Tivat sa te ikone, pa ovdje ukljucite notifikacije.',
    ...
    denied: 'Notifikacije su odbijene u podesavanjima telefona. Dozvolite ih za DVD Tivat, pa otvorite aplikaciju ponovo.',
