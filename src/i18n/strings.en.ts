...
export const en: Strings = {
  ...
  accountAccess: {
    ...
    profileRequired: 'Account created. Enter your name so the owner knows who is requesting access.',
    ...
    profileSaveFailed: 'The name could not be saved. Try again.',
    resetUnavailable: 'Password reset is not available yet. Until then, the system owner must change the password.',
    ...
    awaitingApproval: 'The account is active but has no system permissions yet. Only the owner can assign a role. Operational screens remain unavailable until then.',
    signedInAs: 'Signed-in account', serverRole: 'Server role',
  ...
  accounts: {
    ...
    search: 'Search by name, email, role or status', loading: 'Loading accounts from the server...',
    ...
    auditKicker: 'Permanent audit', auditTitle: 'Role and access changes', noAudit: 'No records yet',
    auditHint: 'This log updates when a role or access changes.',
    ...
    nameAndSurname: 'Full name', displayNotProof: 'Display information, not proof of identity.',
    awaitingApproval: 'Awaiting approval', noRights: 'New accounts have no system permissions.',
    ownerDecision: 'Owner decision', ownerAssigns: 'Only the owner can assign a role.',
    serverCheck: 'Server check', serverChecksRole: 'The server checks the role on every request.',
    roleLabel: { OWNER: 'System owner', ADMIN: 'Administrator', COMMANDER: 'Commander', FIREFIGHTER: 'Firefighter', PENDING: 'Awaiting approval', CITIZEN: 'Citizen (legacy label)' },
