...
| P5 (retire the DVD role mirror) | **Draft PR [#66](https://github.com/Dado211207/dvd-tivat-app/pull/66)** — Stage B — from `claude/dvd-tivat-app-dev-n8wctb-p5`. One migration `202609250038_retire_dvd_role_mirror.sql`; the branch now carries #65's merge (037) too. Independent review at `b9fa781` added two client-only fixes (flag-off membership-audit visibility; membership-derived role search). Not deployed. See the P5 section below. |
